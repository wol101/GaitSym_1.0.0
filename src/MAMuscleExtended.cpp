...
/*
// set the number of bins for the moving average
void MAMuscleExtended::SetSmoothing(int smoothing)
{
    if (vcelist) delete [] vcelist;
    vcelistsize = smoothing;
    vcelist = new dReal[vcelistsize];
    for (int i = 0; i < vcelistsize; i++) vcelist[i] = 0;
    vcelistindex = 0;
    vcesum = 0;
}
*/
    ...
    while (progress == 0)
    {
        ...
        Rule(lse,-(alpha*f0*k + epe*lastlpe + ese*lastlpe - 2*epe*len - ese*len + epe*spe - ese*sse + epe*k*timeIncrement*vmax + 
                   ese*k*timeIncrement*vmax - Sqrt(4*(epe + ese)*k*(alpha*f0 + epe*(lastlpe - spe) + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                                                   Power(alpha*f0*k + epe*(-lastlpe + spe) - ese*(lastlpe - len + sse) + (epe + ese)*k*timeIncrement*vmax,2)))/(2.*(epe + ese)));
        /*Rule(lpe,(alpha*f0*k + epe*lastlpe + ese*lastlpe + ese*len + epe*spe - ese*sse + epe*k*timeIncrement*vmax + ese*k*timeIncrement*vmax - 
                  Sqrt(4*(epe + ese)*k*(alpha*f0 + epe*(lastlpe - spe) + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                       Power(alpha*f0*k + epe*(-lastlpe + spe) - ese*(lastlpe - len + sse) + (epe + ese)*k*timeIncrement*vmax,2)))/(2.*(epe + ese)));
        Rule(fce,(-(alpha*f0*k) - epe*lastlpe - ese*lastlpe + ese*len + epe*spe - ese*sse - epe*k*timeIncrement*vmax - 
                  ese*k*timeIncrement*vmax + Sqrt(4*(epe + ese)*k*(alpha*f0 + epe*(lastlpe - spe) + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                                                  Power(alpha*f0*k + epe*(-lastlpe + spe) - ese*(lastlpe - len + sse) + (epe + ese)*k*timeIncrement*vmax,2)))/2.);
        Rule(vce,(alpha*f0*k - epe*lastlpe - ese*lastlpe + ese*len + epe*spe - ese*sse + epe*k*timeIncrement*vmax + ese*k*timeIncrement*vmax - 
                  Sqrt(4*(epe + ese)*k*(alpha*f0 + epe*(lastlpe - spe) + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                       Power(alpha*f0*k + epe*(-lastlpe + spe) - ese*(lastlpe - len + sse) + (epe + ese)*k*timeIncrement*vmax,2)))/
             (2.*(epe + ese)*timeIncrement));*/
                  ...
                  0.5*timeIncrement*Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                                          ...
                                          alpha*f0*(epe*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe + (-3.214890000000001e6 - 189000.00000000003*k)*spe + 
                                                    ...
                                                    ese*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                                         k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250. + 24999.999999999993*k)*timeIncrement*vmax))))/
                                         Power(timeIncrement,2)))/(945.*epe + 945.*ese));
        Rule(lpe,(-850.5*alpha*f0 - 50.*alpha*f0*k + 472.5*epe*lastlpe + 472.5*ese*lastlpe + 472.5*ese*len + 472.5*epe*spe - 472.5*ese*sse - 
                  62.5*epe*k*timeIncrement*vmax - 62.5*ese*k*timeIncrement*vmax - 
                  0.5*timeIncrement*Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                                          Power(epe,2)*(893025.0000000001*Power(lastlpe,2) - 1.7860500000000002e6*lastlpe*spe + 893025.0000000001*Power(spe,2)) + 
                                          Power(ese,2)*(893025.0000000001*Power(lastlpe,2) - 1.7860500000000002e6*lastlpe*len + 893025.0000000001*Power(len,2) + 
                                                        1.7860500000000002e6*lastlpe*sse - 1.7860500000000002e6*len*sse + 893025.0000000001*Power(sse,2)) + 
                                          ...
                                          alpha*f0*(epe*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe + (-3.214890000000001e6 - 189000.00000000003*k)*spe + 
                                                    ...
                                                    ese*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                                         k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250. + 24999.999999999993*k)*timeIncrement*vmax))))/
                                         Power(timeIncrement,2)))/(945.*epe + 945.*ese));
        Rule(fce,(850.5*alpha*epe*f0 + 850.5*alpha*ese*f0 + 50.*alpha*epe*f0*k + 50.*alpha*ese*f0*k - 472.5*Power(epe,2)*lastlpe - 
                  945.*epe*ese*lastlpe - 472.5*Power(ese,2)*lastlpe + 472.5*epe*ese*len + 472.5*Power(ese,2)*len + 472.5*Power(epe,2)*spe + 
                  472.5*epe*ese*spe - 472.5*epe*ese*sse - 472.5*Power(ese,2)*sse + 62.5*Power(epe,2)*k*timeIncrement*vmax + 
                  125.*epe*ese*k*timeIncrement*vmax + 62.5*Power(ese,2)*k*timeIncrement*vmax + 
                  0.5*epe*timeIncrement*Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                                              ...
                                              alpha*f0*(epe*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe + (-3.214890000000001e6 - 189000.00000000003*k)*spe + 
                                                        ...
                                                        ese*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                                             k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250. + 24999.999999999993*k)*timeIncrement*vmax))))/
                                             Power(timeIncrement,2)) + 0.5*ese*timeIncrement*
                  Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                        ...
                        alpha*f0*(epe*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe + (-3.214890000000001e6 - 189000.00000000003*k)*spe + 
                                  ...
                                  ese*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                       k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250. + 24999.999999999993*k)*timeIncrement*vmax))))/
                       Power(timeIncrement,2)))/(945.*epe + 945.*ese));
        Rule(vce,(-850.5*alpha*f0 - 50.*alpha*f0*k - 472.5*epe*lastlpe - 472.5*ese*lastlpe + 472.5*ese*len + 472.5*epe*spe - 472.5*ese*sse - 
                  62.5*epe*k*timeIncrement*vmax - 62.5*ese*k*timeIncrement*vmax - 
                  0.5*timeIncrement*Sqrt((-4.*(945.*epe + 945.*ese)*k*
                                          (125.*alpha*f0 + 125.*epe*lastlpe + 125.*ese*lastlpe - 125.*ese*len - 125.*epe*spe + 125.*ese*sse)*timeIncrement*vmax + 
                                          Power(alpha*f0*(1701. + 100.*k) + epe*(945.*lastlpe - 945.*spe + 125.*k*timeIncrement*vmax) + 
                                                ese*(945.*lastlpe - 945.*len + 945.*sse + 125.*k*timeIncrement*vmax),2))/Power(timeIncrement,2)))/
             ((945.*epe + 945.*ese)*timeIncrement));
...
*/        
        ...
        /*Rule(lse,(-(alpha*f0*k) - ese*lastlpe + ese*len + ese*sse - ese*k*timeIncrement*vmax + 
                  Sqrt(4*ese*k*(alpha*f0 + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                       Power(alpha*f0*k + ese*(-lastlpe + len - sse + k*timeIncrement*vmax),2)))/(2.*ese));
        Rule(fce,(-(alpha*f0*k) - ese*(lastlpe - len + sse + k*timeIncrement*vmax) + 
                  Sqrt(4*ese*k*(alpha*f0 + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                       Power(alpha*f0*k + ese*(-lastlpe + len - sse + k*timeIncrement*vmax),2)))/2.);
        Rule(vce,-(-(alpha*f0*k) + ese*(lastlpe - len + sse - k*timeIncrement*vmax) + 
                   Sqrt(4*ese*k*(alpha*f0 + ese*(lastlpe - len + sse))*timeIncrement*vmax + 
                        Power(alpha*f0*k + ese*(-lastlpe + len - sse + k*timeIncrement*vmax),2)))/(2.*ese*timeIncrement));*/
...
/*        
        ...
        Rule(lse,(alpha*f0*(0.9 + 0.052910052910052914*k) - 0.5*ese*lastlpe + 0.5*ese*len + 0.5*ese*sse + 
                  0.06613756613756615*ese*k*timeIncrement*vmax + 0.0005291005291005291*timeIncrement*
                  Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                        Power(ese,2)*(893025.0000000001*Power(lastlpe,2) + 893025.0000000005*Power(len,2) - 1.786050000000001e6*len*sse + 
                                      893025.0000000005*Power(sse,2) + 236250.00000000006*k*len*timeIncrement*vmax - 
                        ...
                        alpha*ese*f0*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                      k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250.00000000001 + 25000.000000000004*k)*timeIncrement*vmax)))/
                       Power(timeIncrement,2)))/ese);
        Rule(fce,alpha*f0*(0.9 + 0.052910052910052914*k) - 0.5*ese*lastlpe + 0.5*ese*len - 0.5*ese*sse + 
             0.06613756613756615*ese*k*timeIncrement*vmax + 0.0005291005291005291*timeIncrement*
             Sqrt((10000.*Power(alpha,2)*Power(f0,2)*(17.009999590960987 + k)*(17.010000409039023 + k) + 
                   Power(ese,2)*(893025.0000000001*Power(lastlpe,2) + 893025.0000000005*Power(len,2) - 1.786050000000001e6*len*sse + 
                                 893025.0000000005*Power(sse,2) + 236250.00000000006*k*len*timeIncrement*vmax - 236250.00000000006*k*sse*timeIncrement*vmax + 
                   ...
                   alpha*ese*f0*((3.214890000000001e6 + 189000.00000000003*k)*lastlpe - 3.214890000000001e6*len + 3.214890000000001e6*sse + 
                                 k*(-189000.00000000003*len + 189000.00000000003*sse + (-47250.00000000001 + 25000.000000000004*k)*timeIncrement*vmax)))/
                  Power(timeIncrement,2)));
        Rule(vce,(-0.9*alpha*f0 - 0.052910052910052914*alpha*f0*k - 0.5*ese*lastlpe + 0.5*ese*len - 
                  0.5*ese*sse - 0.06613756613756615*ese*k*timeIncrement*vmax - 
                  0.0005291005291005291*timeIncrement*Sqrt((-3780.*ese*k*(125.*alpha*f0 + ese*(125.*lastlpe - 125.*len + 125.*sse))*timeIncrement*
                                                            vmax + Power(alpha*f0*(1701. + 100.*k) + ese*(945.*lastlpe - 945.*len + 945.*sse + 125.*k*timeIncrement*vmax),2))/
                                                           Power(timeIncrement,2)))/(ese*timeIncrement));
